        ...
        <div className="follow">
          <span>
            <p className="footer-head">
              ...
              <a
                href="https://x.com/OSWeekend?t=vdey0igVTb1qNwUGe40xSw&s=08"
                target="_blank"
                rel="noreferrer"
              >
                <i
              ...
              <a
                href="https://www.instagram.com/osweekend/"
                target="_blank"
                rel="noreferrer"
              >
                <i
              ...
              <a
                href="https://github.com/oscf-io/OSWeekend#open-source-weekend-osw"
                target="_blank"
                rel="noreferrer"
              >
                <i
        ...
        <div className="pair-1">
          <div className="about">
            ...
            <span className="aboutText">
              <p>
                <a href="https://github.com/oscf-io">
                  Open Source Community Foundation{" "}
                </a>{" "}
                <br />
                <a href="https://github.com/oscf-io/CloudCaptain">
                  Cloud Captain
                </a>{" "}
                <br />
